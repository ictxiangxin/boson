...
def bs_generate_python_code(analyzer_table, output=sys.stdout):
    ...
    bs_code_output(output, "\n")
    bs_code_output(output, "This code generated by boson SLR generator.\n", 1)
    ...
    for action_list in action_table:
        ...
        bs_code_output(output,  " " * (max_end_action_len - len(action)) + "\"%s\"" % action)
        bs_code_output(output, "],\n")
    bs_code_output(output, "]\n")
    bs_code_output(output, "\n")
    ...
    for goto_list in goto_table:
        ...
        bs_code_output(output, " " * (max_end_goto_len - len(str(goto_action))) + str(goto_action))
        bs_code_output(output, "],\n")
    bs_code_output(output, "]\n")
    bs_code_output(output, "\n")
    ...
    bs_code_output(output, "if operation_number == 0:\n", 3)
    bs_code_output(output, "\"\"\"\n", 4)
    bs_code_output(output, "Add some code for reduce 0 here...\n", 5)
