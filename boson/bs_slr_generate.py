from boson.bs_analyzer_helper import bs_terminal_set, bs_non_terminal_set, bs_non_terminal_follow_set, bs_non_terminal_closure
...
def bs_slr_generate_table(sentence_set, conflict_report=False, force=False):
    ...
    action_table = [[configure.boson_table_sign_error] * (len(terminal_set) + 1) for _ in range(len(slr_dfa_state))]
