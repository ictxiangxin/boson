...
class BosonLexer:
    def __init__(self):
        ...
        self.__character_set: set = {'m', 'k', 'Z', '8', '|', '_', 'B', '7', 'z', '5', '9', 'u', '=', 'g', 'd', '6', '{', 'U', '\r', '2', 'H', ';', 'C', '~', '>', '$', 'v', 's', ':', 'O', '\n', 'P', 'a', 'L', 'e', 'E', '!', ',', '\\', 'R', 'o', 'N', 'n', 'Y', 'T', 'F', 'j', '[', ' ', 'I', 'y', 'Q', 'S', '%', 'w', 'f', '3', 'i', '-', '*', 'h', 'l', '\'', 'r', 'p', 'D', 'M', '0', 'b', '"', '4', '@', ')', '\t', 'G', 'c', '1', 't', ']', 'W', 'A', 'V', '+', '}', '<', '(', 'q', 'X', 'x', '#', 'J', 'K'}
