...
action_table = [
    ["s1",  "e",   "e",   "s8",  "s2",  "e",   "e",   "e",   "e",   "e"],
    ["s1",  "e",   "e",   "s8",  "s2",  "e",   "e",   "e",   "e",   "e"],
    ["e",   "r8",  "r8",  "e",   "e",   "r8",  "r8",  "r8",  "r8",  "e"],
    ["e",   "r12", "r12", "e",   "e",   "r12", "r12", "r12", "r12", "e"],
    ["e",   "r4",  "s11", "e",   "e",   "r4",  "r4",  "e",   "s10", "e"],
    ["e",   "r9",  "r9",  "e",   "e",   "r9",  "r9",  "s12", "r9",  "e"],
    ["e",   "r5",  "r5",  "e",   "e",   "r5",  "r5",  "r5",  "r5",  "e"],
    ["e",   "e",   "e",   "e",   "e",   "s13", "s14", "e",   "e",   "a"],
    ["e",   "r7",  "r7",  "e",   "e",   "r7",  "r7",  "r7",  "r7",  "e"],
    ["e",   "s15", "e",   "e",   "e",   "s13", "s14", "e",   "e",   "e"],
    ["s1",  "e",   "e",   "s8",  "s2",  "e",   "e",   "e",   "e",   "e"],
    ["s1",  "e",   "e",   "s8",  "s2",  "e",   "e",   "e",   "e",   "e"],
    ["s1",  "e",   "e",   "s8",  "s2",  "e",   "e",   "e",   "e",   "e"],
    ["s1",  "e",   "e",   "s8",  "s2",  "e",   "e",   "e",   "e",   "e"],
    ["s1",  "e",   "e",   "s8",  "s2",  "e",   "e",   "e",   "e",   "e"],
    ["e",   "r1",  "r1",  "e",   "e",   "r1",  "r1",  "r1",  "r1",  "e"],
    ["e",   "r11", "r11", "e",   "e",   "r11", "r11", "s12", "r11", "e"],
    ["e",   "r10", "r10", "e",   "e",   "r10", "r10", "s12", "r10", "e"],
    ["e",   "r6",  "r6",  "e",   "e",   "r6",  "r6",  "r6",  "r6",  "e"],
    ["e",   "r2",  "s11", "e",   "e",   "r2",  "r2",  "e",   "s10", "e"],
    ["e",   "r3",  "s11", "e",   "e",   "r3",  "r3",  "e",   "s10", "e"],
]
