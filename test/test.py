...
if __name__ == "__main__":
    grammar_package = bs_grammar_analysis("test/slr_grammar.boson")
    ...
    print(code)
    grammar_package = bs_grammar_analysis("test/not_slr_grammar.boson")
    ...
    print(code)
    grammar_package = bs_grammar_analysis("test/literal_grammar.boson")
